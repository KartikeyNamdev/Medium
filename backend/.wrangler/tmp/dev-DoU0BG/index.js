...
// .wrangler/tmp/bundle-rfiErZ/checked-fetch.js
...
// node_modules/@kartikeynamdev/medium-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@kartikeynamdev/medium-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    init_virtual_unenv_global_polyfill_process();
...
// .wrangler/tmp/bundle-rfiErZ/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
...
// .wrangler/tmp/bundle-rfiErZ/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
...
userRouter.post("/signin", async (c) => {
  ...
  try {
    ...
    const jwt2 = await sign2({ id: existingUser.id }, c.env.JWT_SECRET);
    return c.json({ jwt: jwt2 });
  } catch (e) {
    return c.json({ e });
  }
...
blogRouter.put("/", async (c) => {
  ...
  const success = import_medium_common2.updateBlog.safeParse(body);
  if (!success) {
    return c.json({
      msg: "Wrong input"
    });
